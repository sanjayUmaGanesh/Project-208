...
def openChatWindow():
    ...
    attach=Button(window,text="Pause",bd=1,bg = '#1e4545',fg = 'white', font = ("Calibri",10))
    attach.place(x=10,y=305)

    text_message = Entry(window, width =43,bg = '#055164',fg = 'white', font = ("Calibri",12))
    text_message.pack()
    text_message.place(x=98,y=306)

    send=Button(window,text="Play",bd=1,bg = '#1e4545',fg = 'white', font = ("Calibri",10))
